...
const jsURL = 'https://raw.githubusercontent.com/aiaot/goindex/master/index.js';
    ...
    <div class="mdui-row">
        <form action='' method='get'>
            <div class="mdui-textfield">
                ...
                <label class="mdui-textfield-label">Auth认证码（通过认证连接获取认证码）</label>
            ...
            <div class="mdui-textfield">
                ...
                <label class="mdui-textfield-label">目录id(目录id不是目录路径，可以是团队盘、目录、或者共享文件夹)/可以不添，不添为根目录</label>
                <input class="mdui-textfield-input" type="text" name="root"/>
            </div>
            <div class="mdui-textfield">
                <i class="mdui-icon material-icons">enhanced_encryption</i>
                <label class="mdui-textfield-label">根目录密码(优先于.password)</label>
                <input class="mdui-textfield-input" type="password" name="root_pass"/>
            </div>
            <div class="mdui-textfield">
                <input class="mdui-btn mdui-color-theme-accent mdui-ripple" type='submit' value="2.生成代码"/>
            </div>
        </form>
    </div>
    <br><br><br><br>
    <h2>
        3.将下面代码复制到<a href="https://dash.cloudflare.com/" target="_blank">Cloudflare Workers</a>中部署：
    </h2>
    <div class="mdui-typo">
